...
def load_default_config(parser):
    ...
    parser.add_argument('--gen_log', type=str, default='log/content/log/data_maker.log')
    ...
    parser.add_argument('--is-normal', type=int, default=0, help='use normalized adjacency matrix, refer to NLocalSAT')
    parser.add_argument('--rnn-type', type=str, default='lstm', help='what kind of rnn')
    ...
    parser.add_argument('--tc_seed', action='store', dest='tc_seed', type=int, default=0)
    parser.add_argument('--np_seed', action='store', dest='np_seed', type=int, default=0)
